...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/wxGTK/Attic/wxGTK-2.8.10.1-r5.ebuild,v 1.14 2011/12/09 03:42:26 dirtyepic dead $
...
src_prepare() {
	...
	# Fix for >=libpng-1.5  Bug #12959
	epatch "${FILESDIR}"/${P}-png-1.5.2.patch
}
